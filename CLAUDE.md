...
## โครงสร้าง
- `pipeline/` Python — ดึง ECMWF (GFS เลิกใช้ 24 ก.ย. 2569 เจ้าของเลือกเอง · `fetch_gfs.py` เก็บไว้เฉยๆ) → ตัดภูมิภาค (lat −5..30, lon 88..122, 0.25°) → PNG ละ 1 ช่วงเวลา + `manifest.json`
